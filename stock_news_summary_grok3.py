...
# Function to call OpenRouter API with Grok3 model
def get_openrouter_response_grok3(prompt):
    url = "https://openrouter.ai/api/v1/chat/completions"
    headers = {
        "Authorization": f"Bearer {OPENROUTER_API_KEY}",
        "Content-Type": "application/json",
        "HTTP-Referer": "https://twitter.com/",
        # "X-Title": "Stock News Summarizer Grok3",
    }
    data = {
        "model": "x-ai/grok-3",
        "messages": [
...
def main():
    ...
    csv_filename = f"stock_summaries_grok3_{timestamp}.csv"
    ...
    for i, ticker in enumerate(tickers, 1):
        ...
        try:
            ...
            forecast = get_openrouter_response_grok3(get_forecast_prompt(ticker))
